    ...
    <tr>
      ...
      <td style="padding:14px 16px;vertical-align:top;">
        <div style="display:flex;align-items:flex-start;gap:8px;">
          ...
          <div>
            <strong style="font-family:'Playfair Display',Georgia,serif;font-size:1.1rem;color:#1a1a2e;">${escapeHtml(p.title)}</strong>
...
<style>
  * { margin: 0; padding: 0; box-sizing: border-box; }
  body { font-family: 'Figtree', sans-serif; max-width: 700px; margin: 40px auto; color: #1a1a2e; padding: 0 24px; }
