...
const HeroSection = ({ onCTA }: HeroSectionProps) => (
  <section className="relative w-full overflow-hidden bg-hero-gradient">
    ...
    <div className="relative max-w-[1100px] mx-auto px-4 sm:px-6 pt-20 pb-16 sm:pt-28 sm:pb-24">
      ...
      >
        <div className="absolute inset-0 rounded-3xl bg-primary/[0.06] blur-3xl -z-10 scale-95" />
        <img
          src={heroMockup}
          alt="Laptop and phone showing exportmymap.com shareable travel guide with saved places from Google Maps"
